                            ...
                            <Grid item>
                                ...
                                <MuiTypography variant="subtitle1" gutterBottom paragraph={true} align="justify">
                                    <p> Al usar Baku, crear su cuenta y usar el sitio para publicar contenido en la comunidad de Baku, incluídos los libros que publica, o para acceder y ver el contenido de Baku o otro contenido de usuario, acepta estos Términos de servicio. Si no está de acuerdo con alguno de estos términos, no puede utilizar los servicios de Baku.   <br />
                                        ...
                                        <br />
                                        Las decisiones de Baku son definitivas. Nos reservamos el derecho de eliminar cualquier contenido o cuentas que violen las políticas de Baku. Al bloquearse su cuenta en la plataforma luego de la acumulación de 10 (diez) reclamos a un libro, si existen otros libros publicados a su nombre, éstos permanecerán publicados ya que se considera que no fueron motivo de reclamos y pueden seguir siendo accesibles para el público que desee leerlos.
                                        <br />
                                        Con respecto a ello, cabe aclarar que el usuario podrá ponerse en contacto con Baku mediante nuestras redes sociales, cuyos links se encuentran al pie de página, para aquellos casos excepcionales en los que los administradores podrán analizar reclamos que no se consideren lo suficientemente válidos, y pueda resultar en el desbloqueo y recupero de su cuenta si así se lo decide, lo cual queda enteramente a criterio administrativo de Baku.
                                        <br />
                                        <br />
